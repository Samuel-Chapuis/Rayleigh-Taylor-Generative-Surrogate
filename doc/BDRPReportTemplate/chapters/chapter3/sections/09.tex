...
The implementation used during training does not simulate the forward SDE by Euler--Maruyama. It samples the exact marginal distribution at a continuous time $t\in[0,1]$. Defining
\begin{equation}
\bar{\alpha}(t)
=
