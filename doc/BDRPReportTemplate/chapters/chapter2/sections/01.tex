...
physical mechanisms without introducing an explicit turbulence model. \citep{MoinMahesh1998} describe DNS as a reference approach for studying turbulent flows, while
also emphasizing its strong dependence on computational resources and spatial
resolution. This limitation is particularly important in
